      ...
      <div className="pt-24 px-4 md:px-8 lg:px-12 pb-12">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">{favorites.length} title{favorites.length !== 1 ? "s" : ""}</p>
          </div>
        </div>
        ...
        {favorites.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-gray-400 mb-6">Heart titles you love to save them here</p>

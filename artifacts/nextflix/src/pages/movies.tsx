import { useGetMovies, getGetMoviesQueryKey } from "@workspace/api-client-react";
...
export default function Movies() {
  ...
  const { data, isLoading } = useGetMovies(
    { page, limit: 20 },
    { query: { queryKey: getGetMoviesQueryKey({ page, limit: 20 }) } }
  );

  return (
    <div className="pt-24 px-6 lg:px-12 pb-20 w-full min-h-screen">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-4xl font-bold text-white tracking-wide">Movies</h1>
      </div>
